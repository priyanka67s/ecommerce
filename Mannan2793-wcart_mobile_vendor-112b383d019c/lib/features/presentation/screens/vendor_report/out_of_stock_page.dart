...
class OutOfStockProductPage extends StatefulWidget {
  const OutOfStockProductPage({super.key});

  @override
  State<OutOfStockProductPage> createState() => _OutOfStockProductPageState();
}

class _OutOfStockProductPageState extends State<OutOfStockProductPage> {
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      CustomAppBar(
                        titleText: 'Out of stock product',
                        onBackButtonPressed: () {},
                      ),
                      const SizedBox(
                        height: 7,
...
//! shimmer Layer
  ...
  ListView dataLayer(VendorReportController controller) {
    return ListView.separated(
        ...
        itemCount:
            controller.lowStockVendorProductData.productData?.length ?? 0,
        itemBuilder: (context, i) {
          int sNo = i + 1;
          return Row(
            children: [
              ...
              Expanded(
                  ...
                  child: Text(
                    controller
                            .lowStockVendorProductData.productData?[i].quantity
                            .toString() ??
                        "",
                    style: const TextStyle(
                      fontSize: 14,
              ...
              Expanded(
                  flex: 3,
                  child: Text(
                    controller.lowStockVendorProductData.productData?[i]
                            .lowStockLimit
                            .toString() ??
                        "",
                    style: const TextStyle(
