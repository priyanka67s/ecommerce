...
class StaffBasedReportPage extends StatefulWidget {
  const StaffBasedReportPage({super.key});

  @override
  State<StaffBasedReportPage> createState() => _StaffBasedReportPageState();
}

class _StaffBasedReportPageState extends State<StaffBasedReportPage> {
                          ...
                          children: [
                            ...
                            Expanded(
                                child: ListView.separated(
                                    ...
                                    itemCount: controller.viewStaffOrderData
                                            .orders?.length ??
                                        0,
