...
class ProcessingPayOutsPage extends StatefulWidget {
  const ProcessingPayOutsPage({super.key});

  @override
  State<ProcessingPayOutsPage> createState() => _ProcessingPayOutsPageState();
}

class _ProcessingPayOutsPageState extends State<ProcessingPayOutsPage> {
...
//! data Layer
  ListView dataLayer() {
    return ListView.builder(
        itemCount: controller.viewProcessingPayoutData.result?.length,
        itemBuilder: (context, i) {
          return Padding(
            padding: const EdgeInsets.all(5.0),
            child: Row(
              ...
              children: [
                Expanded(
                    ...
                    child: Text(controller
                            .viewProcessingPayoutData.result?[i].processId
                            .toString() ??
                        '')),
                Expanded(
                    flex: 3,
                    child: Text(
                      controller
                              .viewProcessingPayoutData.result?[i].processed ??
                          '',
                ...
                Expanded(
                    ...
                    child: Text(
                      controller
                              .viewProcessingPayoutData.result?[i].totalpayouts
                              .toString() ??
                          '',
                      style: const TextStyle(
                        fontSize: 14,
                ...
                Expanded(
                  ...
                  child: MouseRegion(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Get.toNamed(Routes.viewPayoutsPage, arguments: {
