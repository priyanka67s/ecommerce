...
class _CollapsibleSidebarState extends State<CollapsibleSidebar>
  ...
  void initState() {
    ...
    _maxOffsetY = 9 * 2 + widget.iconSize;
  ...
  Widget get _avatar {
    return AnimatedContainer(
      ...
      duration: const Duration(
        milliseconds: 500,
      ), // Adjust the duration for smoother effect
      curve: Curves.easeInOut, // Use easing for a natural effect
      child: SvgIcon(
    ...
    return List.generate(widget.items.length, (index) {
      ...
      return CollapsibleItemWidget(
        ...
        onTap: () {          
          ...
          item.onPressed();
          debugPrint('Selected item: ${item.text}');
