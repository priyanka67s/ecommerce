...
//   StaffOrderReportModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
...
//         vendorPermission!.add(new VendorPermission.fromJson(v));
//       });
//     }
...
//           this.vendorPermission!.map((v) => v.toJson()).toList();
//     }
...
//     data['ssrpid'] = this.ssrpid;
//     data['staff_role_id'] = this.staffRoleId;
//     data['permission_id'] = this.permissionId;
//     data['per_view'] = this.perView;
//     data['per_create'] = this.perCreate;
//     data['per_edit'] = this.perEdit;
//     data['per_delete'] = this.perDelete;
//     return data;
//   }
// }
class StaffOrderReportModel {
