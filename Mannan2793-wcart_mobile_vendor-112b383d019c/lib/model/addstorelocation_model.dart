class AddStoreLocationModel {
  String? status;
  List<ThisStoreLocation>? thisStoreLocation;
  String? message;
  String? vendorPermission;
  String? isOwner;

  AddStoreLocationModel(
      {this.status,
      this.thisStoreLocation,
      this.message,
      this.vendorPermission,
      this.isOwner});

  AddStoreLocationModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['this_store_location'] != null) {
      thisStoreLocation = <ThisStoreLocation>[];
      json['this_store_location'].forEach((v) {
        thisStoreLocation!.add(ThisStoreLocation.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['status'] = status;
    if (thisStoreLocation != null) {
      data['this_store_location'] =
          thisStoreLocation!.map((v) => v.toJson()).toList();
    }
...
class ThisStoreLocation {
  ...
  ThisStoreLocation.fromJson(Map<String, dynamic> json) {
